...
bool Item::updateProperty(const std::string& key, const std::string& value) {
	try {
...
std::string Item::getProperty(const std::string& key) const {
	return properties->at(key);
}
bool Item::removeProperty(const std::string& key) {

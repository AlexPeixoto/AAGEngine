...
BackgroundShape* Dropdown::getBoxShape() const {
	return boxShape;
}
BackgroundShape* Dropdown::getOptionShape() const {
	return optionShape;
}
BackgroundShape* Dropdown::getMenuShape() const {
	return menuShape;
}
Color Dropdown::getMenuOptionColor() const {
	return menuOptionColor;
}
Color Dropdown::getSelectedOptionColor() const {
	return selectedOptionColor;
}
std::string Dropdown::getOption(int index) const{

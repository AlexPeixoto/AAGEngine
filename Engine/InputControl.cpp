...
std::map<int, bool> InputControl::heldKeyboardKey, InputControl::releasedKeyboardKey, InputControl::pressedKeyboardKey;
std::map<int, bool> InputControl::pressedJoystickButton, InputControl::heldJoystickButton, InputControl::releasedJoystickButton;
std::map<int, bool> InputControl::pressedMouseButton, InputControl::heldMouseButton, InputControl::releasedMouseButton;

std::map<int, float> InputControl::joystickAxis;
